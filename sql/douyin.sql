...
CREATE TABLE `t_comment`  (
  ...
  `delete` int(0) NOT NULL DEFAULT 0,
...
CREATE TABLE `t_video`  (
  ...
  `create_date` datetime(0) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 29 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '视频表' ROW_FORMAT = Dynamic;
